                  ...
                  var buildSubTree = function (obj, html, i) {
                    ...
                    $(obj).each(function () {
                      ...
                      if (this.Children && this.Children.length) {
                        t += '<ins class="tree-icon right-down-caret" id="icon-' + i + '"></ins>';
                      } else {
                        t += '<ins class="tree-icon no-caret" id="icon-' + i + '"></ins>';
                      }
                      ...
                      // Add checkboxes for Add, Edit, Delete if it's a leaf node
                      if (!this.Children || !this.Children.length) {
                        t += '<span class="actions">';
                        t += '<input type="checkbox" id="add-' + this.Number + '" name="add-' + this.Number + '"><label for="add-' + this.Number + '">Add</label>';
                        t += '<input type="checkbox" id="edit-' + this.Number + '" name="edit-' + this.Number + '"><label for="edit-' + this.Number + '">Edit</label>';
                        t += '<input type="checkbox" id="delete-' + this.Number + '" name="delete-' + this.Number + '"><label for="delete-' + this.Number + '">Delete</label>';
                        t += '</span>';
                      }
