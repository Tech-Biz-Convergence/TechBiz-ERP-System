...
namespace AspnetCoreMvcFull.Controllers.TechbizAreas.Hr
{
  ...
  public class JobInterviewManagementController : BaseController
  {
    public JobInterviewManagementController(IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor) { }
