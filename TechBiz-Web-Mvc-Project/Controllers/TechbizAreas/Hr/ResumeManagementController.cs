...
namespace AspnetCoreMvcFull.Controllers.TechbizAreas.Hr
{
  ...
  public class ResumeManagementController : BaseController
  {
    public ResumeManagementController(IHttpContextAccessor httpContextAccessor) : base(httpContextAccessor) { }
