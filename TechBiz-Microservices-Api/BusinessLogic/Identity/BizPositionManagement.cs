...
namespace BusinessLogic.Identity
{
    ...
    {
        private PositionRepository m_PositionRepository;

        public BizPositionManagement()
        {
            m_PositionRepository = new PositionRepository();
        }

        public ResultMessage GetAllPosition()
        {
            int total = 0;
        ...
        public ResultMessage AddNewPosition(tbm_position model)
        {
            ...
            using (NpgsqlConnection conn = new NpgsqlConnection(GlobalVariables.ConnectionString))
            {
                ...
                {
                    conn.Open();
                    int id = m_PositionRepository.Insert(model, conn);
        ...
        public ResultMessage UpdatePosition(tbm_position model)
        {
            ResultMessage resultMessage = new ResultMessage();
            using (NpgsqlConnection conn = new NpgsqlConnection(GlobalVariables.ConnectionString))
            {
                ...
                {
                    conn.Open();
                    int id = m_PositionRepository.Update(model, conn);
                    model.position_id = id;
        ...
        public ResultMessage DeletePosition(int key)
        {
            ResultMessage resultMessage = new ResultMessage();
            using (NpgsqlConnection conn = new NpgsqlConnection(GlobalVariables.ConnectionString))
            {
                ...
                {
                    conn.Open();
                    int id = m_PositionRepository.Delete(key, conn);
