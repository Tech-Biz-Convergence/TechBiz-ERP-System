...
$(document).ready(function() {
    ...
    function ShowMainListDataTable()
    {
          Page.mainTableControl = $('#tableShowListId').DataTable({
           ...
           columnDefs: [
                { targets: 0, data: 'leave_type_name', ordering: true },
                { targets: 1, data: 'leave_max_days', ordering: true },
                { targets: 2, data: 'leave_type_comment', ordering: true },
                {
                    targets: 3,
                    data: null,
                    orderable: false,
                    ...
                    render: function (data, type, row) {
                        return `<div class="row"><button type="button" class="btn btn btn-info btn-sm ViewButton col-4" data-id="${row.leave_type_id}" ><i class="bx bx-list-ul me-1"></i></button> ` +
                            ` <button type="button" class="btn btn-primary btn-sm EditButton col-4" data-id="${row.leave_type_id}"><i class="bx bx-edit me-1"></i></button> `+
                            ` <button type="button" class="btn btn-danger btn-sm DeleteButton col-4" data-id="${row.leave_type_id}"><i class="bx bx-trash me-1"></i></button> </div>`;
                    }
                }
            ]
          });
